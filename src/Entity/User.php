 ...
 * @UniqueEntity(fields={"matricule"}, message="Ce matricule est déja utilisé.Veuillez choisir un autre")
 */
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Pointages::class, mappedBy="user", orphanRemoval=true)
     */
    private $pointages;
